	...
	// Save sessid2 cookie
	document.cookie = "sessid2="+escape("sessid20260611182527690")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;

	// Save funnel cookies
	document.cookie = "spi_funnel_codename="+escape("")+";expires="+spiexpire.toGMTString()+";path=/;domain=."+hostname;
				
	document.cookie = "referrer="+("2a00:b703:fff1:102::1::mempezfr.online%2Fztes1-page1-bralive-caps-redtra-bugod-leand-bill")+";expires="+spiexpire.toGMTString()+";path=/;domain="+hostname;
	...
	var spi_replace_str_bg = spi_pattern_base_bg+"sessid2="+escape("sessid20260611182527690")+"&";
	...
	var spi_replace_str_bg_html = spi_pattern_base_bg_html+"sessid2="+escape("sessid20260611182527690")+"&";
	...
	var spi_replace_str_bg_html2 = spi_pattern_base_bg_html2+"sessid2="+escape("sessid20260611182527690")+"&";
	...
	var spi_replace_str_bg_html3 = spi_pattern_base_bg_html3+"sessid2="+escape("sessid20260611182527690")+"&";
	...
	var spi_replace_str_bg_html4 = spi_pattern_base_bg_html4+"sessid2="+escape("sessid20260611182527690")+"&";

	var spi_pattern_enc_spi = "softwareprojects.com%2Fsecure%2F%3F";
	var spi_pattern_base_spi = "softwareprojects.com/secure/?";
	var spi_replace_str_spi = spi_pattern_base_spi+"sessid2="+escape("sessid20260611182527690")+"&";

	var spi_pattern_enc_cbd = "buygoodshomeoils.com%2Fsecure%2F%3F";
	var spi_pattern_base_cbd = "buygoodshomeoils.com/secure/?";
	var spi_replace_str_cbd = spi_pattern_base_cbd+"sessid2="+escape("sessid20260611182527690")+"&";
	...
	var spi_replace_str_cbd_html = spi_pattern_base_cbd_html+"sessid2="+escape("sessid20260611182527690")+"&";
